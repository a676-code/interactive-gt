...
def main():
    ...
    payoffsCanvas.bind('<Configure>', lambda onScroll: payoffsCanvas.configure(scrollregion=payoffsCanvas.bbox("all"), width=100 * numStrats[1], height=40 * numStrats[0]))
    ...
    turnsLabel.grid(row=2, column=0, sticky=E)
    ...
    edit_menu.add_command(label="Enter Values into SimGame Object", command=lambda: entriesToSimGame(G, dimensionsFrame, payoffsFrame))

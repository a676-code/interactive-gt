...
def eliminateStrictlyDominatedStrategies(G, dimensionsFrame, payoffsFrame, steps, oldNumPlayers):
    ...
    pairs = [[] for x in range(numPlayers)]
...
def entriesToSimGame(G, dimensionsFrame, payoffsFrame, oldNumPlayers):
    ...
    if numPlayers < 3:
        ...
        print("sNG:", strategyNamesGet)
        stratNamesPast2 = strategyNamesGet[numStrats[0] + numStrats[1]:]
        print("sNP2:", stratNamesPast2)
        stratNamesPast2Split = [names.split(", ") for names in stratNamesPast2]
        stratNamesPast2SplitNames = []
        for names in stratNamesPast2Split:
            print("names:", names)
            for x in range(numPlayers - 2):
...
def simGameToEntries(G, dimensionsFrame, payoffsFrame):
    ...
    matrixGroupedOutcomesGet = [outcomesGet[n:n + oldNumStrats[0] * oldNumStrats[1]] for n in range(0, numOutcomes, oldNumStrats[0] * oldNumStrats[1])]
    ...
    groupedOutcomesGet = [[matrix[n:n + oldNumStrats[1]] for n in range(0, oldNumStrats[0] * oldNumStrats[1], oldNumStrats[1])] for matrix in matrixGroupedOutcomesGet]
